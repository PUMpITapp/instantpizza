...
function displayInputfield()
	...
	text.print(gfx.screen, arial, tostring(info.name), pos1.x, pos1.y, pos1.w, pos1.h)
	gfx.screen:fill({r=255, g=255, b=255, a=0}, pos2)
	text.print(gfx.screen, arial, tostring(info.age), pos2.x, pos2.y, pos2.w, pos2.h)
	gfx.screen:fill({r=255, g=255, b=255, a=0}, pos3)
	text.print(gfx.screen, arial, tostring(info.adress), pos3.x, pos3.y, pos3.w, pos3.h)
	gfx.update()
end
...
function setInputfield()
	if highlightPos == 1 then
		info.currentInputField = "name"
	elseif highlightPos ==2 then
		info.currentInputField = "age"
	elseif highlightPos ==3 then
		info.currentInputField = "adress"
	end
end
